...
# copy the text of the file you want to convert into a .txt file in this folder called "to_tab.txt", or rename in this file appropriately. cd to this folder in terminal and run this script, the formatted file should appear as "output_file_rb.txt".
